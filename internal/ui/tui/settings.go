...
func settingsRowsFor(language string) []settingRow {
	...
	return []settingRow{
		...
		{"context_window", "Limit kontekstu", "Nadpisuje limit modelu; 0 oznacza automatyczne wykrywanie z providera lub zapamiętanego błędu.", setInt, true},
...
func englishSettingsRows() []settingRow {
	return []settingRow{
		...
		{"context_window", "Context limit", "Overrides the model limit; 0 means automatic provider/error detection.", setInt, true},
