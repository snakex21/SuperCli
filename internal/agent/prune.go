...
const (
	...
	// defaultPruneProtectTokens of the freshest tool results are
	// always kept verbatim (LoopConfig.PruneProtectTokens overrides).
	defaultPruneProtectTokens = 8192
)
